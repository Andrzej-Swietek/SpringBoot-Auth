...
import pl.swietek.springbootapi.filters.JWTAuthFilter;

import static org.springframework.http.HttpMethod.*;
import static pl.swietek.springbootapi.models.Permission.*;
import static pl.swietek.springbootapi.models.Role.*;
...
//                .requestMatchers( "/api/v1/user/**").hasAnyRole(ADMIN.name(), MASTER.name(), USER.name())
